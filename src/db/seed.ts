  ...
  await db.insert(products).values([
    {
      ...
      description: "High-performance power drill with advanced torque control and long battery life",
    ...
    },
    {
      ...
      description: "Compact and powerful impact driver with brushless motor technology",
      price: 4999,
      category: "Power Tools",
      rating: 49,
    },
